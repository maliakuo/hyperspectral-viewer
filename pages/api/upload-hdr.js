...
const uploadDir = path.join(process.cwd(), 'public', 'uploads'); // Ensure this points to public/uploads
...
export default function handler(req, res) {
  ...
  form.parse(req, (err, fields, files) => {
    ...
    try {
      const destPath = path.join(uploadDir, file.originalFilename); // Save file to public/uploads
